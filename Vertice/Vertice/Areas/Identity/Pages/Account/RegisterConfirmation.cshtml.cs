// <copyright file="RegisterConfirmation.cshtml.cs" company="Thomas Castonguay-Gagnon">
...
namespace Vertice.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public RegisterConfirmationModel(UserManager<VerticeUser> userManager, IEmailSender sender)
        {
