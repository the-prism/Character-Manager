// <copyright file="ForgotPassword.cshtml.cs" company="Thomas Castonguay-Gagnon">
...
namespace Vertice.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<VerticeUser> userManager, IEmailSender emailSender)
        {
